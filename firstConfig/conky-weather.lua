...
function weatherDiscliption( cr, x, y, day )
  local Discription = tostring( Archive.command( "ruby ~/scripts/weatherScripts/weather.rb -"..day.." -c" ) )
  local LargeTemp = Archive.command( "ruby ~/scripts/weatherScripts/weather.rb -"..day.." -lt" )
  local SmallTemp = Archive.command( "ruby ~/scripts/weatherScripts/weather.rb -"..day.." -st" )

  local localYear, localMonth, localDay = string.match( Archive.command( "ruby ~/scripts/weatherScripts/weather.rb -"..day.." -day" ), "(%d%d%d%d)(%d%d)(%d%d)" )
...
Weather.putWeather = function( cr )
  local image_today = cairo_image_surface_create_from_png( tostring( os.getenv( "HOME" ) ) .. "/scripts/weatherScripts/.WeatherIcon/png/64/"..Archive.command( "ruby " .. tostring( os.getenv( "HOME" ) ) .. "/scripts/weatherScripts/weather.rb -0 -i" )..".png" )
  local image_tomorrow = cairo_image_surface_create_from_png( tostring( os.getenv( "HOME" ) ) .. "/scripts/weatherScripts/.WeatherIcon/png/64/"..Archive.command( "ruby " .. tostring( os.getenv( "HOME" ) ) .. "/scripts/weatherScripts/weather.rb -1 -i" )..".png" )
  local image_day_after = cairo_image_surface_create_from_png( tostring( os.getenv( "HOME" ) ) .. "/scripts/weatherScripts/.WeatherIcon/png/64/"..Archive.command( "ruby " .. tostring( os.getenv( "HOME" ) ) .. "/scripts/weatherScripts/weather.rb -2 -i" )..".png" )
